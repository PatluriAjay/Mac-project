...
import AssignVendors from "./pages/assignVendors/AssignVendors";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/app" element={<Layout />}>
          ...
          <Route path="/app/search-vendors" element={<SearchVendor />} />
          <Route path="/app/assign-vendors" element={<AssignVendors />} />
