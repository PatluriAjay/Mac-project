...
function EditStore() {
  ...
  const [name, setName] = React.useState("Store Hyderbad");
  ...
  return (
    <div className="padding">
      <h5 className="create-employee mb-3">Edit Store</h5>
        ...
        <div className="row">
              ...
              <div className="col-12 col-lg-8">
                <input
                    ...
                    onChange={(ev) => {
                        ...
                        let val = ev.target.value.replace(regex, "").toLowerCase();
                        setCode(val);
                    }}
                />
              </div>
          ...
          <div className="col-12  mb-3">
            <div className="row align-items-center">
              ...
              <div className="col-12 col-lg-8">
                <input type="text" className="form-control" placeholder="" value={name} onChange={(ev) => {                                 
