...
function ManageStores({navigation}) {
    ...
    return (
        ...
        <h5 className='create-employee mb-3'>Manage Stores</h5>
                                ...
                                <tr key={index} className='table-row-color'>
                                    ...
                                    <td>
                                        <div className='d-flex  align-items-center'>
                                            <button className="btn btn-add me-2" onClick={() => {navigate('/app/edit-store')}}>
                                                <MdEdit /> 
                                            </button>
                                            <button className="btn btn-delete me-2" onClick={() => {deleteLocation(row.account_code, row.location_code)}}>
                                                <MdDelete />
                                            </button>
                                        </div>
                                    </td>
